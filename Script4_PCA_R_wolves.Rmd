...
snpgdsBED2GDS("../data/wolves.bed", 
              "../data/wolves.fam", 
              "../data/wolves.bim", 
              out.gdsfn="../data/wolves2.gds") # Here indicate name file

# See summary 
snpgdsSummary("../data/wolves2.gds")

# Load gds file created from .bed, .fam and .bim files
gdsfile <- snpgdsOpen("../data/wolves2.gds")
...
group <- as.vector(metadata$Ecotype.or.Status) # Do a vector with the information of population of the genetic data with that factor
